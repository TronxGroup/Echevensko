          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="mt-4 text-lg text-neutral-700">
                Charla-espectáculo corporativa presentada por <strong>Cristóbal Echevensko</strong> para organizaciones
                que buscan mejorar clima, engagement y creatividad. Entretenida, práctica y memorable, con aplicación
            ...
            <div>
              ...
              <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <Card className="rounded-2xl overflow-hidden">
                  <CardContent className="p-0">
                    <img src="/images/echevensko_foto3.jpg" alt="Auditorio atento durante la charla" className="w-full h-56 object-cover" />
                  </CardContent>
                </Card>
                <Card className="rounded-2xl overflow-hidden">
                  <CardContent className="p-0">
                    <img src="/images/echevensko_foto4.jpg" alt="Dinámica participativa con equipos" className="w-full h-56 object-cover" />
                  </CardContent>
                </Card>
              </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-2 text-neutral-700 max-w-3xl">
                Ideal para <strong>colegios</strong>, <strong>fundaciones</strong>, <strong>empresas</strong>, <strong>universidades</strong>,
                <strong> municipalidades</strong>, áreas de <strong>salud</strong>, <strong>retail</strong> y <strong>tecnología</strong>. Adaptamos
        ...
        <div className="grid md:grid-cols-5 gap-8">
          <div className="md:col-span-3">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <Button asChild variant="outline" className="rounded-2xl">
                <a href="https://wa.me/56920080031?text=Hola%20quiero%20cotizar%20la%20charla%20corporativa%20de%20Echevensko" rel="noopener">
                  WhatsApp
                </a>
              </Button>
            </div>
