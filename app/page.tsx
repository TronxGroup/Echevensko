...
export default function EchevenskoB2BLanding() {
  return (
    <div className="min-h-screen bg-neutral-50 text-neutral-900">
      ...
      {/* (Opcional) Zoho WebForm Analytics */}
      <Script
        id="wf_anal"
      ...
      {/* CONTACTO (FORMULARIO DISEÑO ORIGINAL + ZOHO + reCAPTCHA v2) */}
      <section id="contacto" className="mx-auto max-w-6xl px-4 py-16">
        <div className="grid md:grid-cols-5 gap-8">
          <div className="md:col-span-3">
            ...
            >
              {/* ===== Zoho obligatorios ===== */}
              <input type="hidden" name="xnQsjsdp" value="45d9b797d479f84068f90d42b00a56219ce832c39eec6842269a4802278cacf1" />
              <input type="hidden" name="zc_gad" id="zc_gad" value="" />
              <input type="hidden" name="xmIwtLD" value="b43dad152065720fc561bb796faf679d9b41423112ae8cc52a6f4ac121fc64ed79d4c6fd1e1e5bad4f6986047f9d8f98" />
              ...
              {/* ===== Campos visibles (diseño original) ===== */}
              ...
              {/* Checkbox privacidad y condiciones (nuevo) */}
              <label className="flex items-start gap-2 text-sm text-neutral-700">
                <input name="privacy_accept" type="checkbox" required />
                <span>
              ...
              {/* === reCAPTCHA (v2 Checkbox) — mantiene tu diseño === */}
              <div className="mt-2">
                <div
